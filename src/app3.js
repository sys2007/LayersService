...
function requestJson(savefile, flag) {
    ...
    request({
        ...
        if (!error && response.statusCode == 200) {
            if (flag) {
                //文件头只写一次
                let head = '_=id:String,tempId:String,name:String,serialNumber:String,oltid:String,ONUType:String,mac:String,onState:String,location:Geometry:srid=4326\r\n'
