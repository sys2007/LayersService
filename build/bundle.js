...
var intervalFun = function intervalFun() {
    download(_config2.default.outfile);
};
...
function requestJson(savefile, flag) {
    ...
    (0, _request2.default)({
        ...
        if (!error && response.statusCode == 200) {
            if (flag) {
                //文件头只写一次
                var head = '_=id:String,tempId:String,name:String,serialNumber:String,platformId:String,Tags:String,ssqy:String,sspt:String,onState:String,location:Geometry:srid=4326\r\n';
